...
<div class="col-md-10">
<a href="mailto:yadavsonu.in@gmail.com" style="color:#000000">sonuyadav.in@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="" width=100 height=100 alt="sonu yadav" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Sonu Yadav</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8239917180</h4>
		<h4 style="font-family:'typo' ">yadavsonu.in@gmail.com</h4>
		<h4 style="font-family:'typo' ">pec</h4></div></div>
		</p>
      </div>
